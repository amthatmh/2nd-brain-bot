...
| `ALERT_CHANNEL_ID` | — | Telegram channel/group ID for operational logs, deploys, and success messages |
| `error_channel_ID` | — | Telegram channel/group ID for warnings, errors, and failures; normal logs never fall back here |
