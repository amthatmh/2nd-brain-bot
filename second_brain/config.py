...
SYSTEM_LOGS_CHAT_ID = int(os.environ.get("SYSTEM_LOGS_CHAT_ID") or MY_CHAT_ID)
...
GOOGLE_HEALTH_CLIENT_ID = os.environ.get("GOOGLE_HEALTH_CLIENT_ID", "").strip()
GOOGLE_HEALTH_CLIENT_SECRET = os.environ.get("GOOGLE_HEALTH_CLIENT_SECRET", "").strip()
GOOGLE_HEALTH_REFRESH_TOKEN = os.environ.get("GOOGLE_HEALTH_REFRESH_TOKEN", "").strip()
...
NOTION_MOVEMENTS_DB = os.environ.get("NOTION_MOVEMENTS_DB", "").strip()
...
NOTION_WOD_LOG_DB = os.environ.get("NOTION_WOD_LOG_DB", "").strip()
