...
- Do NOT include in movements: equipment specs ("20/14 lb Vest", "vest"), coaching cues ("Partition Repetitions as Desired"), rep schemes ("21-15-9"), or any phrase that is not itself a named exercise movement
