...
Environment variables:
  ...
  HABIT_DASHBOARD_SECRET   — shared secret for the public HabitKit dashboard
                             (/habits-data, /log-habit), entered once client-side
  HABIT_DASHBOARD_ORIGIN   — CORS origin allowed to call the HabitKit dashboard
                             endpoints (default: https://amthatmh.github.io)
"""
...
HABIT_DASHBOARD_SECRET: str = os.environ.get("HABIT_DASHBOARD_SECRET", "")
HABIT_DASHBOARD_ORIGIN: str = os.environ.get("HABIT_DASHBOARD_ORIGIN", "https://amthatmh.github.io")
